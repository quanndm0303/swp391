...
public class GoodsDisposalController {
    ...
    public ResponseEntity<?> getDisposedGood(@PathVariable("goodsDisposalId") Integer goodDisposalId){
        //Response
        CustomResponse customResponse = new CustomResponse();
        ...
        //finally
        customResponse.setAll(false,"get disposal good by goods disposal success ",goodsDisposalService.getDisposedGoodByGoodsDisposalId(goodDisposalId));
        return new ResponseEntity<>(customResponse,HttpStatus.OK);
    }
