...
public interface OutboundTransactionDetailRepository extends JpaRepository<OutboundTransactionDetail,Integer> {

    @Query(value = "SELECT otd.id, otd.transaction_id, otd.item_id, otd.quantity, otd.zone_id FROM outboundtransactiondetails otd JOIN" +
