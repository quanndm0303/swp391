...
public class JwtUtil {
    ...
    public static String generateToken(String email) {
        ...
        String payload = Base64.getUrlEncoder().encodeToString(("{\"sub\":\"" + email + "\",\"exp\":" + expirationTimeMillis + "}").getBytes());
    ...
    private static String sign(String data) {
        try {
            ...
            SecretKeySpec secretKey = new SecretKeySpec(SECRET_KEY.getBytes(StandardCharsets.UTF_8), HMAC_ALGO);
    ...
    public static boolean isTokenExpired(String token) {
        ...
        String payload = new String(Base64.getUrlDecoder().decode(parts[1]));
        long expiration = Long.parseLong(payload.substring(payload.indexOf("\"exp\":") + 6, payload.length() - 1));
